    ...
    <form class="form p-6" @submit.prevent="suscribeNewsletter">
      ...
      <div class="mb-4">
        <label class="block text-grey font-bold flex items-center">
          <!-- <toggle-input :value="form.newsletter" @input="value => { this.form.newsletter = value}" /> -->
      ...
      <div class="mb-4">
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full">Register</button>
      </div>
    </form>
  </div>
</template>
